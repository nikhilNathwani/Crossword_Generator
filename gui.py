...
class GameBoard():
    def __init__(self, parent, cross, solution, length, color1="white", color2="black"):
    ...
    def refresh(self, event):
        ...
        for row in range(self.rows):
            for col in range(self.columns):
                ...
                self.canvas.create_text(x1+self.size/2,y1+self.size/2+4,text=str(self.solution[row][col]), font="Times 32", tags="nums")
